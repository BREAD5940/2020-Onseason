...
public class FishyLinearSystemLoop<States extends Num, Inputs extends Num,
        Outputs extends Num> {
    ...
    private FishyLinearQuadraticRegulator<States, Inputs, Outputs> m_controller;
    private KalmanFilter<States, Inputs, Outputs> m_observer;
    private Matrix<States, N1> m_nextR;

    public FishyLinearSystemLoop(Nat<States> states, Nat<Inputs> inputs, Nat<Outputs> outputs,
                                 LinearSystem<States, Inputs, Outputs> plant,
                                 FishyLinearQuadraticRegulator<States, Inputs, Outputs> controller,
     ...
     */
    public FishyLinearQuadraticRegulator<States, Inputs, Outputs> getController() {
        return m_controller;
    }
